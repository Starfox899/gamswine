...
docker run -it --name "${IMAGE_NAME}_${VERSION}" -e DISPLAY=${DISPLAY} -v /tmp/.X11-unix:/tmp/.X11-unix:ro ${FULL_NAME} /usr/bin/wine /home/gamsuser/.wine/drive_c/GAMS/win32/24.5/gamside.exe
